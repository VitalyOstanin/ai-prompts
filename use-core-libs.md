...
Корень core-libs:
/home/vyt/devel/bitkogan/code/core-libs

он содержит подкаталоги для git worktree, они же git branches.

IMPORTANT: Искать core-libs уровнем выше, в /home/vyt/devel/bitkogan/code/ - запрещено!
